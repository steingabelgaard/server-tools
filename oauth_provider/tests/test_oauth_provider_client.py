...
class TestOAuthProviderClient(TransactionCase):
    ...
    def test_get_oauth2_server_mobile_application(self):
        ...
        self.assertTrue(
            isinstance(
                client.get_oauth2_server(), oauth2.MobileApplicationServer
            )
        )
    ...
    def test_get_oauth2_server_legacy_applicaton(self):
        ...
        self.assertTrue(
            isinstance(
                client.get_oauth2_server(), oauth2.LegacyApplicationServer
            )
        )
    ...
    def test_get_oauth2_server_backend_application(self):
        ...
        self.assertTrue(
            isinstance(
                client.get_oauth2_server(), oauth2.BackendApplicationServer
            )
        )
    ...
    def test_get_oauth2_server_validator(self):
        ...
        self.assertTrue(
            isinstance(
                client.get_oauth2_server().request_validator, OdooValidator
            )
        )
